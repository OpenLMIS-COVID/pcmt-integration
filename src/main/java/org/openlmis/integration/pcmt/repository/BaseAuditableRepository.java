...
/**
 * Extension of {@link PagingAndSortingRepository} to enable using generic parameters in creating
 * Javers logs and provide additional methods to retrieve entities using the pagination and sorting
