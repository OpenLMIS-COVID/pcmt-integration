...
package org.openlmis.integration.pcmt.exception;
...
public class ValidationMessageException extends BaseMessageException {
  ...
  /**
   * Create a new validation exception with the given message and cause. Message is constructed from
   * message key and message parameters.
   *
   * @param cause             the exception.
