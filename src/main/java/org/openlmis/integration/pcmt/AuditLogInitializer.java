...
import org.openlmis.integration.pcmt.repository.BaseAuditableRepository;
...
/**
 * AuditLogInitializer runs after its associated Spring application has loaded. It examines each
 * domain object in the database and registers them with JaVers if they haven't already been so.
 * This is, in part, a fix for
