 ...
 * consistent with the use of UTC within JaVers' domain. (Otherwise, JaVers uses the default system
 * timezone, which may change, when constructing a LocalDateTime.)
 */
